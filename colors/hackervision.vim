" Vim color file
" Name: hackervision.vim (based on greenvision.vim)
" Maintainer: Mikhail Zavoloka <mikhail.zavoloka@gmail.com>
" Last Change: 2025-11-18
" License: Vim License
" Revision: 1
...
let g:colors_name = 'hackervision'
...
hi CursorLine		guifg=#00ff00 guibg=#001700 gui=none ctermfg=000 ctermbg=002 cterm=none
hi CursorLineNr		guifg=#00ff00 guibg=#001700 gui=underline ctermfg=000 ctermbg=002 cterm=underline
...
hi FoldColumn		guifg=#00bb00 guibg=#000300 gui=bold ctermfg=046 ctermbg=016 cterm=bold
hi Folded		guifg=#00bb00 guibg=#001200 gui=bold ctermfg=010 ctermbg=022 cterm=bold
hi Identifier		guifg=#50d930 guibg=#000000 gui=none ctermfg=028 ctermbg=000 cterm=none
hi LineNr		guifg=#005900 guibg=#000600 gui=none ctermfg=034 ctermbg=016 cterm=none
...
hi Normal		guifg=#00bb00 guibg=#000000 gui=none ctermfg=002 ctermbg=000 cterm=none
...
hi Search		guibg=#008800 guifg=#000000 gui=none cterm=none
...
hi ColorColumn      guibg=#001600           ctermbg=236
